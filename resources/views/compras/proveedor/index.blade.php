...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<h3>Listado de Proveedores<a href="proveedor/create"><button class="btn btn-warning">Nuevo</button></a></h3>
...
<div class="row">
	...
	<div class="table-responsive">
		...
		<thead>
			...
			@foreach ($persona as $per)<!--revisar si esta bien las variables-->
